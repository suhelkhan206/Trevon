...
public class MyEarnings extends AbstractActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        earningAdapter = new EarningAdapter(MyEarnings.this,earningCOList);
        RecyclerView.LayoutManager mLayoutManager2 = new LinearLayoutManager(MyEarnings.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i= new Intent(MyEarnings.this, SearchPage.class);
            startActivity(i);
        }
        ...
        else if (item.getItemId()==R.id.notification_home)
        {
            ...
            {
                Intent i =new Intent(MyEarnings.this,Notification.class);
                startActivityForResult(i, IConstants.INTENT_CART_COUNT_CODE);// Activity is started with requestCode 2
            }
            else
            {
                Toast.makeText(this, "Login First", Toast.LENGTH_SHORT).show();
                Intent ilogin = new Intent(MyEarnings.this,LoginOriginal.class);
        ...
        else if (item.getItemId()==R.id.action_cart)
        {
            ...
            if(AppValidate.isNotEmpty(userCO.id))
            {
                Intent i =new Intent(MyEarnings.this,CartScreen.class);
                startActivityForResult(i, IConstants.INTENT_CART_COUNT_CODE);// Activity is started with requestCode 2
            }
            else
            {
