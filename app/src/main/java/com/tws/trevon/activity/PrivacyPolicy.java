...
public class PrivacyPolicy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Toolbar dash_board_toolbar = findViewById(R.id.privacy_policy_tool);
        ...
        {
            web_popup_view.loadUrl(UserCO.getUserCOFromDB().web_term_conditions);
        }
        else
        {
            web_popup_view.loadUrl("https://www.twstechnology.com/grocery/FrontEndPages/web_term_conditions");
        }
