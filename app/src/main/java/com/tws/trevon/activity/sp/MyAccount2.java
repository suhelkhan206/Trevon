...
public class MyAccount2 extends AbstractFragment {

    Uri mInvitationUrl;
    View view;
    LinearLayout profile, my_earning, invite_friend
            ,my_bank_detail,logout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_my_account2, container, false);
    ...
    protected void onViewClick(View view) {
        switch(view.getId()) {
            case R.id.profile:
                Intent iMySharedCatelog = new Intent(getActivity(), EditProfileActivity2.class);
                startActivity(iMySharedCatelog);
                break;


            case R.id.my_earning:
                Intent iMyEarnings = new Intent(getActivity(), MyEarnings2.class);
            ...
            case R.id.my_bank_detail:
                Intent i = new Intent(getActivity(), MyBankDetails2.class);
                startActivity(i);
                break;
            case R.id.logout:
